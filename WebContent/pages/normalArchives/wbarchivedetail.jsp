...
<%
	if(request.getParameter("source")!=null && request.getParameter("source").toString().equals("1")){
%>
<table class="table-info" cellpadding="0" cellspacing="1" width="98%" align="center">
	<th width="25%">来文审批信息</th>
	<td width="75%"><a href="#"  onclick="openParentSPView('${runId}','${runId}','${runId}','${runId}')">来文审批信息</a></td>
</table>
<%} %>
<h1 align="center" style="padding:10px;font-size:20px;">文 本 评 审 单</h1> 
...
<input type="hidden" id="textPSRunId" value="${runId}" />
