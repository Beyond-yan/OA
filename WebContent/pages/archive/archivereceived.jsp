...
<%@page import="com.gdssoft.oa.service.archive.ArchivesHandleService"%>
<%@page import="com.gdssoft.oa.model.archive.ArchivesHandle"%>
...
<table class="table-info" cellpadding="0" cellspacing="1" width="98%"
	...
	<tr>
		<th width="15%">来文类型</th>
		<td>${arch.archives.odFlowtype.flowName}</td>
		<th width="15%">公文来源</th>
