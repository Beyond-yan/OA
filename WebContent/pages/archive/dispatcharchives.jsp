...
<%@page import="com.gdssoft.oa.service.archive.ArchDispatchService"%>
<%@page import="com.gdssoft.oa.model.archive.ArchDispatch"%>
<%
...
<table class="table-info" cellpadding="0" cellspacing="1" width="98%"
	...
	<tr>
		<th width="15%">来文类型</th>
		<td>${archDispatch.archives.odFlowtype.flowName}</td>
		<th width="15%">公文来源</th>
