...
<script src="<%=basePath%>/js/leaderActivities/EditWeileaderFormJsp.js"
	type="text/javascript"></script>
<script type="text/javascript">
var __ctxPath="<%=request.getContextPath()%>";
function openWindow(activeId,fullname,userId){
	var CurrentUserId=<%=ContextUtil.getCurrentUser().getUserId()%>;
	 new EditWeileaderFormJsp(activeId,fullname,userId,CurrentUserId,function(){window.location.href="../leaderActivities/WeileaderActive.do?schamal=${schamal}&Q_startTime_D_GE=${currentTime}&weekType=${weekType}";});
}
...
<body>
	...
	<div class="schedule">
		<div class="title">
			...
			<ul class="tab">
				<!-- <li ><a
					href="<c:url value="/pages/leader/weileaderscheduler.jsp?schamal=${schamal}&weekType=${weekType}&startTime_D_GE=${currentTime}"/>">显示一月</a>
				</li> -->
				<li ><a
					href="<c:url value="WeileaderActive.do?schamal=${schamal}&weekType=1&startTime_D_GE=${currentTime}"/>">显示一周</a>
				</li>
				<li ><a
					href="<c:url value="WeileaderActive.do?schamal=${schamal}&weekType=2&startTime_D_GE=${currentTime}"/>">
						显示两周</a></li>
				<li ><a
					href="<c:url value="WeileaderActive.do?schamal=${schamal}&startTime_D_GE=${Q_startTime_D_GE}&weekType=${weekType}"/>">回到今天</a>
				</li>
				<li ><a
					href="<c:url value="WeileaderActive.do?schamal=${schamal}&startTime_D_GE=${lastStartDt}"/>&weekType=${weekType}">上一页</a>
				</li>
				<li ><a
					href="<c:url value="WeileaderActive.do?schamal=${schamal}&startTime_D_GE=${nextStartDt}&weekType=${weekType}"/>">下一页</a>
				</li>
			</ul>
		</div>
		<!--con Start-->
			...
			<table border="1px" style="border-collapse: collapse;"
				...
				<tr class="leaderSch_blue">
					<th width="50%"><span style="padding-left: 14px;"
						name="mapDate">${dateMap["1-1"]}</span><span
						style="padding-left: 65px;">星期一</span>
					</th>
					<th width="50%"><span style="padding-left: 14px;"
						name="mapDate">${dateMap["1-2"]}</span><span
