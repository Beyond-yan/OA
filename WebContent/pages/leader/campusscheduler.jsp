...
<script type="text/javascript" charset="utf-8">
	$(function(){
		initSchedulrer();
		var url = "<%=request.getContextPath()%>/leaderActivities/leader.do";
				...
				<div id="scheduler_here" class="dhx_cal_container"
					...
					<div class="dhx_cal_navline">
						...
						<div  style="right: 50px;background-color: #C2D5FC">
							<a href="<c:url value="/leaderActivities/leaderActive.do?weekType="/><%=weekType%>&Q_startTime_D_GE=<%=currentTime%>" style="text-decoration: none;">
