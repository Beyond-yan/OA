...
<%
      //关于文件下载时采用文件流输出的方式处理：
      ArchivesDepService arDepService = (ArchivesDepService) AppUtil
      ...
      String fPath ="attachFiles/"+fileAttach.getFilePath();
      String filePath = request.getRealPath(fPath);
      ...
      finally
      {
          ...
          if(outp != null)
          {
        	  ...
        	  arDepService.updateDownload(archivesId,userId);
      }
%>