...
<center class="Noprint">
	<table border="0" style="padding-top:30px;">
		<tr>
			<td align="left"><h1 align="center" style="font-size:30px;">中共重庆市交通委员会党委</h1></td>
			<td rowspan="2" align="left"><h1 style="font-size:35px;">收文处理笺</h1></td>
		</tr>
		<tr>
			<td align="left"><h1 style="padding-top:3px;font-size:30px;">重&nbsp;庆&nbsp;市&nbsp;交&nbsp;通&nbsp;委&nbsp;员&nbsp;会</h1></td>
		</tr>
	</table>
</center>
<center>
