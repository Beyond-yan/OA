...
<h1 align="center" style="padding:10px;font-size:20px;">法律意见书发文稿笺</h1> 

<span style="float:right;padding-right:30px;padding-bottom:2px;">创建日期:<fmt:formatDate value="${arch.createtime}" pattern="yyyy-MM-dd"/></span>
<table class="table-info" cellpadding="0" cellspacing="1" width="95%" align="center">
  <tr>
     <th width="15%">发文字号</th>
