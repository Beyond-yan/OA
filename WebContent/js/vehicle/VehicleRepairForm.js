		...
		.extend(
				Ext.Window,
				{
					...
					constructor : function(_cfg) {
						...
						VehicleRepairForm.superclass.constructor.call(this, {
							layout : 'fit',
							id : 'VehicleRepairFormWin',
							title : '车辆维修详细信息',
						...
						this.formPanel = new Ext.FormPanel(
								{
									...
									layout : 'form',
									id : 'VehicleRepairForm',
									frame : false,
									bodyStyle : 'padding:5px;',
									defaults : {
										anchor : '100%,100%'
									},
									formId : 'VehicleRepairFormId',
						...
						this.buttons = [
								{
									...
									iconCls : 'btn-save',
									handler : function() {
										var fp = Ext.getCmp('VehicleRepairForm');
								...
								},
								{
									...
									iconCls : 'btn-cancel',
									handler : function() {
										Ext.getCmp('VehicleRepairFormWin').close();
									}
								} ];// end of the buttons
