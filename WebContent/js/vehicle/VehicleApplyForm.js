 ...
 * @author
 * @createtime
 * @class VehicleApplyForm
 * @extends Ext.Window
 * @description VehicleApplyForm表单
 * @company 宏天软件
 */
VehicleApplyForm = Ext
		.extend(
				Ext.Window,
				{
					// 内嵌FormPanel
					...
					constructor : function(_cfg) {
						...
						VehicleApplyForm.superclass.constructor.call(this, {
							layout : 'fit',
							id : 'VehicleApplyFormWin',
							title : '车辆申请详细信息',
						...
						this.buttons = [
								{
									...
									if(stratDate>=endDate){
										...
										var fp = Ext.getCmp('VehicleApplyForm');
													...
													.submit(
															{
																...
																success : function(
																	...
																	if (fp != null) {
																		Ext.Ajax
																				.request( {
																					url : __ctxPath + '/;/saveProcessActivity.do',
																					waitMsg : '正在提交流程表单信息...',
																					params : {
																						defId : 21,
																						// runId:this.runId,
									...
									iconCls : 'btn-cancel',
									handler : function() {
										Ext.getCmp('VehicleApplyFormWin').close();
									}
								} ];// end of the buttons
