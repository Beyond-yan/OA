																	...
																	.confirm(
																			...
																			function(
																				...
																				if (btn == 'yes') {
																					// 删除图片
																					var profileId = Ext
																							.getCmp('empProfileForm.profileId')
																							.getValue();
																					Ext.Ajax
																							.request(
																									{
									...
									items : [{
										...
										listeners : {
											...
											select : function(combo, record,
													index) {
												Ext
														.getCmp('empProfileForm.standardId')
														.setValue(record.data.standardId);
												Ext
														.getCmp('empProfileForm.standardMiNo')
														.setValue(record.data.standardNo);
												Ext
														.getCmp('empProfileForm.standardMoney')
