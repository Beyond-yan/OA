 ...
 * 用户选择器
 */
var DeptUserSelector = {
	/**
	 * 
	 * @param {} callbackOrConf 回调函数或配置选项，若为map类型，则表示为配置选项
	 * @param {} isSingle 是否单选
	 * @param {} isForFlow 是否为工作流的配置选择
	 * @return {} url2 是否根据schema选择
	 */
	getView : function(callbackOrConf,isSingle,map,url1,url2) {
		//单选
		var callback=null;
		...
		var panel=this.initPanel(isSingle,url1,map);
	...
	initPanel : function(isSingle,url1,map) {
		...
		var schemaUrl = __ctxPath + '/system/listDepartment.do';
		if(url1) schemaUrl = url1;
