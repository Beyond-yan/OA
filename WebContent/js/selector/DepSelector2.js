...
var DepSelector2 = {
	 ...
	 * @param isSingle　是否单选
	 */
	getView : function(callback,isSingle,map,url) {
		...
		var store = new Ext.data.Store({
					proxy : new Ext.data.HttpProxy({
							url : url?url : __ctxPath + '/system/findDepDepartment.do?depId=' + roleMap.get('DepartmentCommonId')
							}),
		...
		store.on('load',function(){
			  var grid = Ext.getCmp('DepSelector2Grid');
