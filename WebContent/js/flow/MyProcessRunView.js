		...
		this.searchPanel=new HT.SearchPanel({
							...
							items:[{
								...
								items : [{
									...
									text : '时间:',
									width : 80
								},{xtype:'datefield',name:'Q_vo.createtime_D_GT',format:'Y-m-d',width : 130},
								{
									xtype : 'label',
									style : 'padding-left:5px;',
									text : '至',
									width : 20
								},{xtype:'datefield',name:'Q_vo.createtime_D_LT',format:'Y-m-d',width : 130}]
							},{
								xtype : 'container',
								layout : 'column',
								style : 'padding-left:0px;margin-bottom:4px;',
			...
			columns : [sm, new Ext.grid.RowNumberer(), {
						...
						renderer : function(value, metadata, record, rowIndex,colIndex) {
							...
							if(piId!=null && piId!=undefined && piId!=''){		
								str += '&nbsp;<a href="#"  onclick="MyProcessRunView.detail('+
