...
ProDefinitionForm.prototype.setup = function() {
	...
	var formPanel = new Ext.FormPanel({
				...
				items : [{
							...
							id:'proDefinition.name'
						}, {
							fieldLabel : '序号',
							name : 'proDefinition.sequence'
						}, {
							fieldLabel : '描述',
							xtype:'textarea',
			...
			Ext.getCmp("proDefinition.defXml").readOnly=false;
			Ext.getCmp("proDefinition.name").readOnly=false;
			}
