		...
		.extend(
				Ext.Window,
				{
					...
					constructor : function(_cfg) {
						...
						WorkSummarySumAuthForm.superclass.constructor.call(this, {
							id : 'WorkSummarySumAuthFormWin',
							layout : 'fit',
					...
					initUIComponents : function() {
						...
						this.formPanel = new Ext.FormPanel( {
							...
							items : [ {
								...
								name : 'Q_typeNo_N_EQ',
								xtype : 'hidden',
								id : 'WSSAuthFrmqtypeno'
							}, {
								fieldLabel : '汇总人',
								name : 'workSummarySum.createUserName',
								id : 'WSSAuthFrmCreateuserName',
								allowBlank : false,
								value : curUserInfo.fullname,
								anchor : '30%'
							},

							yearnoSelect, comboSType, comboSTypeNo, {
								fieldLabel : '总结标题',
						...
						// Ext.getCmp('wordSummarySumCreateuserName').setValue('');
					...
					save : function() {
						$postForm( {
							...
							callback : function(fp, action) {
								var gridPanel = Ext
										.getCmp('WSSAuthVwSummarySumGrid');
								if (gridPanel != null) {
					...
					sum : function() {
						// alert('开始汇总！');
						Ext.getCmp('WSSAuthFrmqyear').setValue('');
						Ext.getCmp('WSSAuthFrmqtype').setValue('');
						Ext.getCmp('WSSAuthFrmqtypeno').setValue('');
						// Ext.getCmp('WSSAuthFrmqdept').setValue(Ext.getCmp('departmentcombo').getValue());
						// alert(Ext.getCmp('WSSAuthFrmqyear').getValue() + ',' +
						// Ext.getCmp('WSSAuthFrmqtype').getValue() + ','+
						// Ext.getCmp('WSSAuthFrmqtypeno').getValue() + ','+
						// Ext.getCmp('WSSAuthFrmqdept').getValue());
						var conf = {
						...
						Ext.Ajax.request( {
							...
							success : function(response, options) {
								...
								Ext.getCmp('WSSAuthFrmsumcontent').setValue(
										resultObj.result);
								if (params.callback) {
								}
							},
						...
						// Ext.getCmp('WSSAuthFrmsumcontent').setValue(resultObj.result);
						// }
						// });
					...
					filter : function() {
						...
						Ext.getCmp('WSSAuthFrmqyear').setValue(
								new Date(Ext.getCmp('WSSAuthFrmsummaryyear').getValue())
										.getFullYear());
						Ext.getCmp('WSSAuthFrmqtype').setValue(
								Ext.getCmp('WSSAuthFrmcomboType').getValue());
						Ext.getCmp('WSSAuthFrmqtypeno').setValue(
								Ext.getCmp('WSSAuthFrmcomboTypeno').getValue());
						// Ext.getCmp('WSSAuthFrmqdept').setValue(Ext.getCmp('departmentcombo').getValue());
						$search( {
