...
WorkSummaryForm = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		WorkSummaryForm.superclass.constructor.call(this, {
			id : 'WorkSummaryFormWin',
			layout : 'fit',
	...
	initUIComponents : function() {
			...
			items : [
					...
					},
					{
						...
						store : new Ext.data.SimpleStore( {
							...
							listeners : {
								load : function() {
										Ext.getCmp('WSFrmdepartmentcombo')
		...
		if (this.summaryid != null && this.summaryid != 'undefined') {
			...
			Ext.getCmp('WSFrmdepartmentcombo').setValue('1');
		}
