...
MeetingRoomForm = Ext.extend(Ext.Window, {
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
						...
						items : [{
									...
									items : [{
												xtype : 'textfield',
												name : 'boardroo.roomType',
												fieldLabel : '会议室类型',
												width : 130,
												allowBlank : false,
												blankText : '请输入类型！',
												maxlength : 64,
												maxLengthText : '您输入的会议室类型信息不能超过64个字！'
										}, {
											xtype : 'textfield',
											name : 'boardroo.manageOrg',
											fieldLabel : '管理单位',
											width : 130,
											allowBlank : false,
											blankText : '请输入单位！',
											maxlength : 200,
											maxLengthText : '您输入的单位信息不能超过200个字！'
									}]
								},{
									columnWidth : 0.5,
									layout : 'form',
									...
									items : [{
												...
												height : 50,
												maxLength : '500',
												maxLengthText : '其他描述不能超过500个字符长度！'
											}]
								}]
					}]				
		});
		...
		this.topbar.add(new Ext.Button({
			...
			scope : this,			
			handler : function() {
				var grid = Ext.getCmp("MeetingRoomFormGrid");
	...
	save : function(formPanel, window) {
		var details = [];
		var gridPanel = Ext.getCmp('MeetingRoomFormGrid');
		if (gridPanel != null) {
