/**
 * @author:LiuSicen
 * @class OfficeMeetingChangeTaskWin
 * @extends Ext.Panel
 * @description 自由跳转管理
 */
OfficeMeetingChangeTaskWin = Ext.extend(Ext.Window, {
			// 条件搜索Panel
			searchPanel : null,
			// 数据展示Panel
			gridPanel : null,
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				OfficeMeetingChangeTaskWin.superclass.constructor.call(this, {
							id : 'OfficeMeetingChangeTaskWin',
							iconCls : 'btn-edit',
							title : '流程编辑',
							layout : 'form',
							modal : true,
			...
			freeJump:function(){
					...
					form.submit({
						...
						success : function(fp, action) {
							...
							Ext.getCmp('OfficeMeetingChangeTaskWin').close();
