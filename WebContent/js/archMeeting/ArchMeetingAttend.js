ArchMeetingAttend = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	// 数据展示Panel
	gridPanel : null,
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		ArchMeetingAttend.superclass.constructor.call(this, {
					id : 'ArchMeetingAttend',
	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
					url : __ctxPath + "/meetingNotice/listAttendMeetingMeetingNotice.do",
					baseParams : {
						'toDoType': 2
					},
					root : 'result',
		...
		var cm = new Ext.grid.ColumnModel({
			columns : [sm, new Ext.grid.RowNumberer({
						...
						renderer : function(value, metadata, record, rowIndex,colIndex){
							...
							var str = '<a href="#" title="'+value+'"'+' style="text-decoration:none;color:#0358A3" onMouseOver = "this.style.color =\'red\'" onMouseOut = "this.style.color=\'#0358A3\'" onclick="ArchMeetingAttend.detail('+record.data.noticeId+','+record.data.runId+','+record.data.defId+')">'+value+'</a>';
							return str;
						}
					}, {
						header : 'archiveId',
						...
						renderer : function(value, metadata, record, rowIndex,colIndex) {
							...
							var str = '';
							str +=  '<a href="#" style="text-decoration:none;color:#3D3D3D" onMouseOver = "this.style.color =\'red\'" onMouseOut = "this.style.color=\'#3D3D3D\'" onclick="ArchMeetingAttend.proDetail('
 ...
 *            editId
 */
ArchMeetingAttend.detail = function(editId,runId,defId) {
	var isGranted=false;
 ...
 * 
 */
ArchMeetingAttend.proDetail = function(runId, defId, piId, name) {
