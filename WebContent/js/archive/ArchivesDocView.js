	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
					...
					fields : [{
								name : 'docId',
								type : 'int'
							}, 'fileId', 'archivesId', 'creator', 'creatorId',
		...
		var cm = new Ext.grid.ColumnModel({
					columns : [sm, new Ext.grid.RowNumberer(), {
								...
								header : '文档状态',// 0=修改中 1=修改完成',
								dataIndex : 'docStatus'
							}, {
								header : '当前版本',// 取当前最新的版本',
			...
			if (btn == 'yes') {
				Ext.Ajax.request({
							...
							success : function(response, options) {
								...
								Ext.getCmp('ArchivesDocGrid').getStore()
										.reload();
							},
