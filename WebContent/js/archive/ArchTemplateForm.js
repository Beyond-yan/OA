	...
	initComponents:function(){
		this.formPanel=new Ext.FormPanel({
				...
				items : [{
								...
								fieldLabel : this.isGenre==0?'模板名称':'印章名称',
								...
								items:[
									{
										...
										items:{
											xtype:'textfield',
											fieldLabel :this.isGenre==0?'模板文件':'印章文件',
										...
										handler:function(){
											...
											new OfficeTemplateView(fileId,path,false,function(fileId,filePath){
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
				...
				success : function(fp, action) {
					...
					var gridPanel1=Ext.getCmp('sealTemplateGrid');
					if(gridPanel!=null){
