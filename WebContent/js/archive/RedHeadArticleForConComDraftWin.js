 ...
 * @extends Ext.Panel
 */
RedHeadArticleForConComDraftWin = Ext.extend(Ext.Window, {
	formPanel : null,
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		this.init();
		RedHeadArticleForConComDraftWin.superclass.constructor.call(this, {
					title : '发文修改',
					id : 'RedHeadArticleForConComDraftWin',
	...
	addArchiveDoc : function() {
		...
		new ArchTemplateSelector({
					callback : function(fileId, tempPath) {
						...
						var curView = Ext.getCmp('RedHeadArticleForConComDraftWin');
						// 返回文档附加记录
	...
	init : function() {
		...
		this.docGridPanel = new Ext.grid.EditorGridPanel({
			...
			columns : [new Ext.grid.RowNumberer(), sm, {
						...
						renderer : function(value, metadata, record, rowIndex,
								colIndex) {
							var str = '';
							str += '<button title="历史版本" value=" " class="btn-archive-history" onclick="RedHeadArticleForConComDraftWin.attach('
									+ value + ')">&nbsp;&nbsp;</button>';
							return str;
						}
					}]
		...
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
						...
						id : 'RedHeadArticleForConComDraftWin.archivesId',
						xtype : 'hidden',
						...
						items : [{
...

							{
								...
								items : [{
									xtype : "textfield",
									name : 'archives.issueDep',
									id : 'RedHeadArticleForConComDraftWin.issueDep',
									fieldLabel : "拟稿单位",
									value:'运营分公司',
									readOnly:true,
									width : 140
						...
						items : [/*{
									...
									items : {
										...
										id : 'RedHeadArticleForConComDraftWin.archivesNo',
										xtype : 'textfield',
										allowBlank : false,
										anchor : '100%'
									}
								},*/ 
								{
									fieldLabel : '标题',
									name : 'archives.subject',
									id : 'RedHeadArticleForConComDraftWin.subject',
									xtype : 'textfield',
									allowBlank : false,
									width : '80%'
								}, {
								    ...
								    width : '80%',
									allowBlank : false,
									id : 'RedHeadArticleForConComDraftWin.recDepNames'
								},{
									fieldLabel : '抄报',
									xtype : 'textfield',
									name : 'archives.handlerUnames',
								    width : '80%',
									id : 'RedHeadArticleForConComDraftWin.handlerUnames'
								},/*
									 * { fieldLabel : '主题词', name :
								...
								{
									name : 'archives.fileCounts',
									id : 'RedHeadArticleForConComDraftWin.fileCounts',
									xtype : 'hidden'
								}]
...
RedHeadArticleForConComDraftWin.attach = function(value) {
	var grid = Ext.getCmp("archiveDocGrid");
	var selectRecords = grid.getSelectionModel().getSelections();
