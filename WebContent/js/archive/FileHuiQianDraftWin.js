Ext.ns('FileHuiQianDraftWin');
/**
 * @description 文件会签修改页面
 * @class FileHuiQianDraftWin
 * @extends Ext.Panel
 */
FileHuiQianDraftWin = Ext
		.extend(
				Ext.Window,
				{
					formPanel : null,
					constructor : function(_cfg) {
						...
						this.init();
						FileHuiQianDraftWin.superclass.constructor.call(this, {
							title : '发文修改',
							id : 'FileHuiQianDraftWin',
						...
						new ArchTemplateSelector( {
							callback : function(fileId, tempPath) {
								...
								var store = Ext.getCmp('archiveDocGrid')
										.getStore();
								var curView = Ext.getCmp('FileHuiQianDraftWin');
								// 返回文档附加记录
								...
								columns : [
										...
										},
										{
											...
											renderer : function(value,
													...
													colIndex) {
												var str = '';
												str += '<button title="历史版本" value=" " class="btn-archive-history" onclick="FileHuiQianDraftWin.attach(' + value + ')">&nbsp;&nbsp;</button>';
												return str;
											}
										} ]
							});
													...
													,
													{
														...
														items : [
																...
																},
																{
																	...
																	text : '选择部门',
																	handler : function() {
																		var depIdsTemp=Ext.getCmp('archivesWin.recDepIds').getValue();
																		var depNamesTemp=Ext.getCmp('archivesWin.recDepNames').getValue();
																		var array1=[];
																		var array2=[];
																	...
																	/*	DepSelector.getView(function(depIds,depNames) {
																							...
																							Ext.getCmp('archivesWin.recDepNames').setValue(depNames);},false).show();*/
...
FileHuiQianDraftWin.attach = function(value) {
	var grid = Ext.getCmp("archiveDocGrid");
