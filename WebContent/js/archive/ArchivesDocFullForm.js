 ...
 */
ArchivesDocFullForm = Ext.extend(Ext.Window, {
	// 内嵌FormPanel
	formPanel : null,
	// 构造函数
	constructor : function(_cfg) {
		...
		ArchivesDocFullForm.superclass.constructor.call(this, {
					id : 'ArchivesDocFullFormWin',
					layout : 'fit',
					border : false,
	...
	initUIComponents : function() {
		this.docPanel=new NtkOfficeFullPanel({
							showToolbar : true,
							fileId:this.fileId,
							height : 480
						});
	...
	show : function() {
		...
		ArchivesDocFullForm.superclass.show.call(this);
		if(this.fileId){
