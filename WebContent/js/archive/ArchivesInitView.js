Ext.ns('ArchivesInitView');
/**
 * 联合发文拟稿
 * @author Ropen
 * @date 2014.3.10
 */
var ArchivesInitView = function() {
	return this.getView();
};

ArchivesInitView.prototype.getView = function() {
 ...
 * 建立视图
 */
ArchivesInitView.prototype.setup = function() {
	var record_start = 0;
...
//				}, 
				{
					...
					renderer : function(value, metadata, record, rowIndex,
						...
						var str = '';
						str += '&nbsp;<a  href="#"    onclick="ArchivesInitView.newFlow('
							+ '' + defId + ',\'' + name + '\')">启动</a>';
						if (deployId != null) {
							str += '&nbsp;<a href="#"  onclick="ArchivesInitView.view('
									+ defId + ',\'' + name + '\')">查看</a>';
						}
						return str;
					}
 ...
 * 初始化数据
 */
ArchivesInitView.prototype.store = function() {
	var store = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : __ctxPath + '/flow/listProDefinition.do?typeId=1300633'
						}),
 ...
 *            deployId
 */
ArchivesInitView.view = function(defId, name) {
 ...
 *            name
 */
ArchivesInitView.newFlow = function(defId, name) {
