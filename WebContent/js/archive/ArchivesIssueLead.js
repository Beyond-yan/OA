...
/**
 * @author:
 * @class ArchivesIssueLead
 * @extends Ext.Panel
 * @description 拟稿管理
 */
ArchivesIssueLead = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	// 数据展示Panel
	gridPanel : null,
			...
			columns : [sm, new Ext.grid.RowNumberer(), {
						...
						renderer : function(value, metadata, record, rowIndex,
							...
							if (isGranted('_ArchivesIssueLeadEdit')) {
								str += '<button title="编辑" value=" " class="btn-edit" onclick="ArchivesIssueLead.edit('
										+ editId + ')">&nbsp;&nbsp;</button>';
							}
							str += '<button title="查阅详情" value=" " class="btn-archives-detail" onclick="ArchivesIssueLead.detail('
									+ editId + ')">&nbsp;&nbsp;</button>';
							return str;
						}
					}],
 ...
 * 修改
 */
ArchivesIssueLead.edit = function(editId) {
	// 只允许有一个编辑窗口
 ...
 *            editId
 */
ArchivesIssueLead.detail = function(editId) {
