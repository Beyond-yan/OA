 ...
 * @author
 * @createtime
 * @class ConferenceSmsMobileForm
 * @extends Ext.Window
 * @description SmsMobile表单
 * @company 宏天软件
 */
ConferenceSmsMobileForm = Ext.extend(Ext.Window, {
			// 内嵌FormPanel
			formPanel : null,
			// 构造函数
			constructor : function(_cfg) {
				...
				ConferenceSmsMobileForm.superclass.constructor.call(this, {
							id : 'ConferenceSmsMobileFormWin',
							layout : 'fit',
