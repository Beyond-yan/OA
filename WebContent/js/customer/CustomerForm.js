...
CustomerForm = Ext.extend(Ext.Window, {
	...
	initUIComponents : function() {
		...
		items : [{
					...
					value : this.customerId == null ? '' : this.customerId
						...
						fieldLabel : '客户编号<a style="color:red;">*</a>',
						items : [ {
								xtype : 'textfield',
								width : 207,
					...
					blankText:'客户名称不能为空!'
						...
						xtype : 'compositefield',
						fieldLabel : '客户经理<a style="color:red;">*</a>',
						items : [ {
								xtype : 'textfield',
								width : 270,
								readOnly : true,
	...
	if (this.customerId != null && this.customerId != 'undefined') {
        ...
        //this.formPanel.getCmpByName('getNoButton').hide();
								...
								success : function(fp, action) {
									...
									if(customerId ==null || customerId =='' || customerId == 'undefined'){
										...
										Ext.Msg.confirm('操作信息','客户信息保存成功！是否为客户增加联系人?',function(btn){
											if(btn=='yes'){
												CustomerView.addLinkman(customerId,customerName);
											}
										});
									}
