...
ArchFondForm = Ext.extend(Ext.Window, {
					...
					items : [{
...

							{
								...
								items : {
									fieldLabel : '全宗名',
									width : 100,
									id : 'ArchFondForm.archFond.afName',
							...
							, {
								...
								items : {
									fieldLabel : '全宗分类',
									width : 100,
									id : 'ArchFondForm.archFond.typeName',
								...
								items : {
									fieldLabel : '案卷数',
									width : 100,
									id : 'ArchFondForm.archFond.caseNums',
...

							{
								...
								items : {
									fieldLabel : '状态',
									width : 100,
									id : 'ArchFondForm.archFond.status',
...

							{
								...
								items : {
									fieldLabel : '开放形式',
									id : 'ArchFondForm.archFond.openStyle',
...

							{
								...
								items : {
									fieldLabel : '全宗概述',
									width : 604,
									id : 'ArchFondForm.archFond.shortDesc',
...

							{
								...
								items : {
									fieldLabel : '全宗描述',
									width : 604,
									id : 'ArchFondForm.archFond.descp',
									name : 'archFond.descp',
									xtype : 'textarea',
									maxLength : 65535
								}
...

							{
								...
								items : {
									fieldLabel : '全宗整理描述',
									id : 'ArchFondForm.archFond.clearupDesc',
	...
	reset : function() {
		...
		Ext.getCmp('ArchFondForm.archFond.afNo').reset();
		Ext.getCmp('ArchFondForm.archFond.afName').reset();
		Ext.getCmp('ArchFondForm.archFond.typeName').reset();
		Ext.getCmp('ArchFondForm.archFond.caseNums').reset();
		Ext.getCmp('ArchFondForm.archFond.status').reset();
		Ext.getCmp('ArchFondForm.archFond.openStyle').reset();
		Ext.getCmp('ArchFondForm.archFond.shortDesc').reset();
		Ext.getCmp('ArchFondForm.archFond.descp').reset();
		Ext.getCmp('ArchFondForm.archFond.clearupDesc').reset();
	},
	/**
	 * 取消
	 * 
