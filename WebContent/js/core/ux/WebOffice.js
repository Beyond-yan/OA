...
WebOffice=function(id){
	...
	this.htmlObj="<object id='"+this.id+"' height='100%' width='100%' style='LEFT: 0px; TOP: 0px'  classid='clsid:E77E049B-23FC-4DB8-B756-60529A35FAD5' codebase='"+__ctxPath+"/js/core/weboffice/weboffice_V6.0.4.6.cab#V6,0,4,6'>";
    this.htmlObj +="</object>";
...
WebOffice.prototype.openDoc=function(path,type){
	...
	this.urlPath=path;
	obj.LoadOriginalFile(path,type);
}
...
WebOffice.prototype.saveDoc=function(config){
	...
	this.urlPath=__fullPath+'/attachFiles/' + obj.filePath;
