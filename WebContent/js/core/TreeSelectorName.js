/**下拉树工具类
 * 用法: new TreeSelectorName(_id,_url,_label,_field,_isBlank); 返回类型为Ext.form.ComboBox
 * @param {} _id:下拉树的ID
 ...
 */
var TreeSelectorName = function(_id,_url,_label,_field,_isBlank) {
	var config={
		id:_id,
	...
	tree.on('click', function(node) {
				...
				if(node.id!=null&&node.id!=''){
					...
					if(editField !=null){
						editField.setValue(node.text); //把树结点的值赋给要修改的域
					}
				}
	});
