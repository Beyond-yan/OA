/**
 * @author:
 * @class CustChargeHistoryView
 * @extends Ext.Panel
 * @description [CustChargeHistory]管理
 * @company 深圳捷达世软件有限公司
 * @createtime:
 */
...
CustChargeHistoryView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		CustChargeHistoryView.superclass.constructor.call(this, {
			id : 'CustChargeHistoryView',
			title : '消费缴费历史',
			region : 'center',
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel( {
			...
			// 使用RowActions
			rowActions : true,
			id : 'CustChargeHistoryGrid',
			url : __ctxPath + "/diningMgnt/getuserdineDiningCharge.do?ALL=true",
			fields : [ {
				name : 'userid',
				type : 'int'				
