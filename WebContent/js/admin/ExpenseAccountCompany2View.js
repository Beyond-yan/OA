/**
 * @author:
 * @class ExpenseAccountCompany2View
 * @extends Ext.Panel
...
ExpenseAccountCompany2View = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		ExpenseAccountCompany2View.superclass.constructor.call(this, {
					id : 'ExpenseAccountCompany2View',
					title : '公司费用报销管理',
					region : 'center',
					layout : 'fit',
	...
	/*	this.topbar = new Ext.Toolbar({
		...
		this.gridPanel = new HT.GridPanel({
			...
			fields : [{
						name : 'id',
						type : 'int'
					},'applyId','applyName', 'compactId', 'applyDate', 'department.depName', 'compactId','budgetProjectName','budgetProjectAccount',
	...
	editRs : function(record) {	
		...
		new ExpenseAccountHistoryForm({
				expenseId: record.data.id,
				levelType:1  //1:公司费用报销; 2:表示个人费用报销
			}).show();
	...
	detail:function(record){
		var id = record.data.id;
		new ExpenseAccountHisDetailForm({
				expenseId: record.data.id,
				levelType:1  //1:公司费用报销; 2:表示个人费用报销
			}).show();
