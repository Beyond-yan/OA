		...
		columns : [sm, new Ext.grid.RowNumberer(), {
					...
					renderer : function(value, metadata, record, rowIndex,colIndex) {
						...
						if(isGranted('_OfficeGoodsDel')){
							str = '<button title="删除" value=" " class="btn-del" onclick="OfficeGoodsView.remove('+ editId + ')">&nbsp;</button>';
						}
						if(isGranted('_OfficeGoodsEdit')){
							str += '&nbsp;<button title="编辑" value=" " class="btn-edit" onclick="OfficeGoodsView.edit('+ editId + ')">&nbsp;</button>';
						}
						return str;
					}
				}],
