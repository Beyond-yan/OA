				...
				columns : [
						...
						},
						{
							...
							renderer : function(value, metadata, record,
								...
								var str = '<button title="删除" value=" " class="btn-del" onclick="AssetsTypeView.remove(' + editId + ')">&nbsp;</button>';
								str += '&nbsp;<button title="编辑" value=" " class="btn-edit" onclick="AssetsTypeView.edit(' + editId + ')">&nbsp;</button>';
								return str;
							}
						} ],
				defaults : {
