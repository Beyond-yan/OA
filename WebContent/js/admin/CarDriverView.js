 ...
 * @createtime:
 */
Ext.ns('CarDriverView');
CarDriverView = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		CarDriverView.superclass.constructor.call(this, {
					id : 'CarDriverView',
					title : '司机管理',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.searchPanel = new HT.SearchPanel({
			...
			items : [{
						...
						iconCls : 'search',
						handler : function() {
							var searchPanel = Ext.getCmp('CarDriverSearchForm');
