											...
											},
											{
												...
												renderer : function(value,
													...
													if (isGranted('_CarRepairDel')) {
														str = '<button title="删除" value=" " class="btn-del" onclick="CartRepairView.remove(' + editId + ')">&nbsp;</button>';
													}
													if (isGranted('_CarRepairEdit')) {
														str += '&nbsp;<button title="编辑" value=" " class="btn-edit" onclick="CartRepairView.edit(' + editId + ')">&nbsp;</button>';
													}
													return str;
												}
											} ],
