/**
 * @author:
 * @class ExpenseAccountPersonal2View
 * @extends Ext.Panel
 * @description [ExpenseAccountPersonal]管理
 * @company 深圳捷达世软件有限公司
 * @createtime:
 */
ExpenseAccountPersonal2View = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		ExpenseAccountPersonal2View.superclass.constructor.call(this, {
			id : 'ExpenseAccountPersonal2View',
			title : '个人费用报销维护',
			region : 'center',
			layout : 'form',
	...
	/*	new ExpenseAccountPersonalForm( {
		...
		//	"Q_expenseId_S_EQ" :	 record.data.id
			expenseId: record.data.id,
			levelType:2  //1:公司费用报销; 2:表示个人费用报销
		}).show();
	},
