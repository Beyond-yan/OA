 ...
 * @company 捷达世软件
 */
OffsupplyApplyOneVForm = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		OffsupplyApplyOneVForm.superclass.constructor.call(this, {
			id : 'OffsupplyApplyOneVFormWin',
			layout : 'form',
	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.Store({
			proxy : new Ext.data.HttpProxy({
				url : __ctxPath + "/admin/getDetailsOffsupplyApplyOne.do?id="+this.id
			}),
