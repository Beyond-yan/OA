...
import com.gdssoft.oa.model.task.PlanInfo;
...
public class CalendarPlanAction extends BaseAction{
	...
	public String list(){
		...
		filter.addSorted("endTime", "Desc");//按结束日期倒叙排列
	 ...
	 */
	public String save(){
		if(calendarPlan.getPlanId()==null){//新增
			...
			/*if(calendarPlan.getTaskType()==2){//如果是非期限任务
				cp.getStartTime().setTime(0);	
				cp.getEndTime().setTime(0);							
				}*/
			try{
