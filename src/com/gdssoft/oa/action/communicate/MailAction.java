...
public class MailAction extends BaseAction {
	...
	public String display() {
		...
		List<Mail> list = EMailHelper.getFromMailServer(mail,"INBOX");
//		for(Mail coremail:list){
//			String result=EMailHelper.coremail_service("login", mail);
//			result=result.substring(0, result.indexOf("webname")-1);
//			String readMailUrl = "mbox/viewmail.jsp?"+result+"&mid="+coremail.getMid();
//			try {
//	            readMailUrl = java.net.URLEncoder.encode(readMailUrl,"UTF-8");
//	        } catch (UnsupportedEncodingException e) {
//	        }
//			String url="http://10.224.5.179/coremail/XJS/index.jsp?"+result+"&firstShowPage="+readMailUrl;
//			coremail.setFilenames(url);
//		}
		getRequest().setAttribute("mailList",list);
