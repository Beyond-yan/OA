 ...
 */
public class Regulation extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.system.GlobalType globalType;
	...
	public com.gdssoft.oa.model.system.GlobalType getGlobalType () {
		return globalType;
	}	
	
	public void setGlobalType (com.gdssoft.oa.model.system.GlobalType in_globalType) {
	...
	public void setProTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        globalType = new com.gdssoft.oa.model.system.GlobalType(aValue);
