...
/**
 * CarPassFeeCard Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class CarPassFeeCard extends com.gdssoft.core.model.BaseModel {
	@Expose
    protected Long id;
	@Expose
	...
	/**
	 * Default Empty Constructor for class CarPassFeeCard
	 */
	public CarPassFeeCard () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class CarPassFeeCard
	 */
	public CarPassFeeCard (
		 Long in_id
        ) {
	...
	/**
	 * 	 * @return Short
	 * @hibernate.property column="CATEGORY" type="java.lang.Short" length="5" not-null="true" unique="false"
	 */
	 ...
	 * @spring.validator type="required"
	 */	
	public void setCategory(Short aValue) {
	...
	/**
	 * 	 * @return String
	 * @hibernate.property column="SN" type="java.lang.String" length="30" not-null="false" unique="false"
	 */
	public String getSn() {
		return this.sn;
	}
	...
	/**
	 * 	 * @return String
	 * @hibernate.property column="REMAINS" type="java.lang.String" length="18" not-null="false" unique="false"
	 */
	 ...
	 * @hibernate.property column="BUY_DATE" type="java.util.Date" length="23" not-null="false" unique="false"
	 */
	...
	/**
	 * 	 * @return java.util.Date
	 * @hibernate.property column="VALID_S_DATE" type="java.util.Date" length="23" not-null="false" unique="false"
	 */
	...
	/**
	 * 	 * @return java.util.Date
	 * @hibernate.property column="VALID_E_DATE" type="java.util.Date" length="23" not-null="false" unique="false"
	 */
	...
	/**
	 * 	 * @return String
	 * @hibernate.property column="COST" type="java.lang.String" length="10" not-null="false" unique="false"
	 */
	...
	public boolean equals(Object object) {
		if (!(object instanceof CarPassFeeCard)) {
			return false;
		}
		CarPassFeeCard rhs = (CarPassFeeCard) object;
		return new EqualsBuilder()
				...
				.append(this.remains, rhs.remains)
				.append(this.buyDate, rhs.buyDate)
				.append(this.validSDate, rhs.validSDate)
				.append(this.validEDate, rhs.validEDate)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				...
				.append(this.remains) 
				.append(this.buyDate) 
				.append(this.validSDate) 
				.append(this.validEDate) 
				.append(this.remark) 
				.append(this.status) 
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("sn", this.sn) 
				.append("remains", this.remains) 
				.append("buyDate", this.buyDate) 
				.append("validSDate", this.validSDate) 
				.append("validEDate", this.validEDate) 
