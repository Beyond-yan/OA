 ...
 */
public class DocHistory extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.archive.ArchivesDoc archivesDoc;
	...
	public com.gdssoft.oa.model.archive.ArchivesDoc getArchivesDoc () {
		return archivesDoc;
	}	
	
	public void setArchivesDoc (com.gdssoft.oa.model.archive.ArchivesDoc in_archivesDoc) {
	...
	public void setDocId(Long aValue) {
	    if (aValue==null) {
	        ...
	        archivesDoc = new com.gdssoft.oa.model.archive.ArchivesDoc(aValue);
