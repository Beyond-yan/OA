 ...
 */
public class SmsHistory extends com.gdssoft.core.model.BaseModel {
	...
	protected AppUser recipientsId;
	
	public AppUser getRecipientsId(){
		return recipientsId;
	}
	
	public void setRecipientsId(AppUser recipientsId){
