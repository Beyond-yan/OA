 ...
 */
public class OutMail extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.communicate.OutMailFolder outMailFolder;
	...
	public com.gdssoft.oa.model.communicate.OutMailFolder getOutMailFolder () {
		return outMailFolder;
	}	
	
	public void setOutMailFolder (com.gdssoft.oa.model.communicate.OutMailFolder in_outMailFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        outMailFolder = new com.gdssoft.oa.model.communicate.OutMailFolder(aValue);
