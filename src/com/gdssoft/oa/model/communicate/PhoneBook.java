 ...
 * ���������
 */
public class PhoneBook extends com.gdssoft.core.model.BaseModel {
	...
	@Expose
	protected com.gdssoft.oa.model.communicate.PhoneGroup phoneGroup;
	...
	public com.gdssoft.oa.model.communicate.PhoneGroup getPhoneGroup () {
		return phoneGroup;
	}	
	
	public void setPhoneGroup (com.gdssoft.oa.model.communicate.PhoneGroup in_phoneGroup) {
	...
	public void setGroupId(Long aValue) {
	    if (aValue==null) {
	        ...
	        phoneGroup = new com.gdssoft.oa.model.communicate.PhoneGroup(aValue);
