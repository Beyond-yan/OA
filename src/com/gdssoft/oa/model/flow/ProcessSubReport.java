...
public class ProcessSubReport extends com.gdssoft.core.model.BaseModel{
	...
	public ProcessSubReport(Long defid, Date createtime, Long userid,
			String creator, String shortcontent,String issuedep, String subject, String name,
			Long runid, String piid, Long archivesid, String datavalue,Integer runStatus) {
		this.defid = defid;
...
//		}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.name, rhs.name).append(
				...
				.append(this.defid, rhs.defid).append(
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.name)
				...
				.append(this.piid).append(this.userid).toHashCode();
	}
