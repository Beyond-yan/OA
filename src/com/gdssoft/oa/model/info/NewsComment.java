 ...
 */
public class NewsComment extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.info.News news;
	...
	public com.gdssoft.oa.model.info.News getNews () {
		return news;
	}	
	
	public void setNews (com.gdssoft.oa.model.info.News in_news) {
		this.news = in_news;
	}
	...
	public void setNewsId(Long aValue) {
	    if (aValue==null) {
	        ...
	        news = new com.gdssoft.oa.model.info.News(aValue);
