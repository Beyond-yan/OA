 ...
 * ������������
 */
public class ReportParam extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.system.ReportTemplate reportTemplate;
	...
	public com.gdssoft.oa.model.system.ReportTemplate getReportTemplate () {
		return reportTemplate;
	}	
	
	public void setReportTemplate (com.gdssoft.oa.model.system.ReportTemplate in_reportTemplate) {
	...
	public void setReportId(Long aValue) {
	    if (aValue==null) {
	        ...
	        reportTemplate = new com.gdssoft.oa.model.system.ReportTemplate(aValue);
