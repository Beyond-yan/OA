 ...
 * subordinate
 */
public class UserSub extends com.gdssoft.core.model.BaseModel {

	@Expose
    protected Long subId;
	@Expose
	protected com.gdssoft.oa.model.system.AppUser subAppUser;
	@Expose
	protected java.lang.Long userId;
//	protected com.gdssoft.oa.model.system.AppUser appUser; //下属
...
//	}
	...
	public com.gdssoft.oa.model.system.AppUser getSubAppUser() {
		return subAppUser;
	}

	public void setSubAppUser(com.gdssoft.oa.model.system.AppUser subAppUser) {
	...
	public void setSubUserId(Long aValue) {
	    if (aValue==null) {
	    	...
	    	subAppUser = new com.gdssoft.oa.model.system.AppUser(aValue);
