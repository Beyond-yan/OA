...
/**
 * SysDataTransferHis Base Java Bean, base class for the.oa.model, mapped directly to database table
 * 
 * Avoid changing this file if not necessary, will be overwritten. 
 *
 * 
 */
public class SysDataTransferHis extends com.gdssoft.core.model.BaseModel {
	...
	/**
	 * Default Empty Constructor for class SysDataTransferHis
	 */
	public SysDataTransferHis () {
		super();
	}
	
	/**
	 * Default Key Fields Constructor for class SysDataTransferHis
	 */
	public SysDataTransferHis (
		 Long in_id
        ) {
	...
	/**
	 * 	 * @return Long
	 * @hibernate.property column="HIS_ID" type="java.lang.Long" length="22" not-null="true" unique="false"
	 */
	 ...
	 */	
	public void setHisId(Long aValue) {
		this.hisId = aValue;
	}	
	...
	public boolean equals(Object object) {
		if (!(object instanceof SysDataTransferHis)) {
			return false;
		}
		SysDataTransferHis rhs = (SysDataTransferHis) object;
		return new EqualsBuilder()
				.append(this.id, rhs.id)
				.append(this.hisId, rhs.hisId)
