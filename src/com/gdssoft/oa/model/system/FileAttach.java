...
public class FileAttach extends com.gdssoft.core.model.BaseModel {
	...
	public void setFileId(BigInteger aValue) {
		this.fileId = aValue.longValue();
	}
	/**
	 * 文件名 * @return String
	 * 
	...
	public String toString() {
		return new ToStringBuilder(this).append("fileId", this.fileId).append(
				...
				.append("creator", this.creator).append("totalBytes",
						this.totalBytes).toString();
	}
