...
public class PlanAttend extends com.gdssoft.core.model.BaseModel {

    protected Long attendId;
	protected Short isDep;
	protected Short isPrimary;
	protected com.gdssoft.oa.model.task.WorkPlan workPlan;
	...
	public com.gdssoft.oa.model.task.WorkPlan getWorkPlan () {
		return workPlan;
	}	
	
	public void setWorkPlan (com.gdssoft.oa.model.task.WorkPlan in_workPlan) {
	...
	public void setPlanId(Long aValue) {
	    if (aValue==null) {
	        ...
	        workPlan = new com.gdssoft.oa.model.task.WorkPlan(aValue);
