...
public class WorkPlan extends com.gdssoft.core.model.BaseModel {
    ...
    @Expose
	protected com.gdssoft.oa.model.task.PlanType planType;
    @Expose
	...
	public com.gdssoft.oa.model.task.PlanType getPlanType () {
		return planType;
	}	
	
	public void setPlanType (com.gdssoft.oa.model.task.PlanType in_planType) {
	...
	public void setTypeId(Long aValue) {
	    if (aValue==null) {
	        ...
	        planType = new com.gdssoft.oa.model.task.PlanType(aValue);
