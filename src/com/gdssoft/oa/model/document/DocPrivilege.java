 ...
 *
 */
public class DocPrivilege extends com.gdssoft.core.model.BaseModel {
	...
	protected com.gdssoft.oa.model.document.Document document;
	protected com.gdssoft.oa.model.document.DocFolder docFolder;
	...
	public com.gdssoft.oa.model.document.Document getDocument () {
		return document;
	}	
	
	public void setDocument (com.gdssoft.oa.model.document.Document in_document) {
		this.document = in_document;
	}
	
	public com.gdssoft.oa.model.document.DocFolder getDocFolder () {
		return docFolder;
	}	
	
	public void setDocFolder (com.gdssoft.oa.model.document.DocFolder in_docFolder) {
	...
	public void setFolderId(Long aValue) {
	    if (aValue==null) {
	        ...
	        docFolder = new com.gdssoft.oa.model.document.DocFolder(aValue);
	...
	public void setDocId(Long aValue) {
	    if (aValue==null) {
	        ...
	        document = new com.gdssoft.oa.model.document.Document(aValue);
